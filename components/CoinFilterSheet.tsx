...
function FilterOptionRow({ option, isSelected, onPress }: {
  ...
  return (
    ...
    >
      ...
      {isSelected && (
        <Feather name="check" size={20} color="#4A9EFF" />
      )}
    </Pressable>
  );
}
...
export default function CoinFilterSheet({ visible, onClose, filters, onApply, initialOpenCategory }: CoinFilterSheetProps) {
  ...
  React.useEffect(() => {
    if (visible) {
      ...
      if (vf && vf.startsWith("customVol:")) {
        const parts = vf.replace("customVol:", "").split("-");
        setCustomVolMin(parts[0]);
        setCustomVolMax(parts[1]);
      }
      if (vf && vf.startsWith("customRvol:")) {
        setCustomRvolPct(vf.replace("customRvol:", ""));
      }
      setAthPeriod("all");
      setAthPct("");
      setAthDir("over");
            ...
            >
              ...
              {detailCategory === "marketCap" ? (
                <>
                  ...
                  <View style={styles.customInputSection}>
                    ...
                    <View style={styles.customInputRow}>
                      ...
                      >
                        <Feather name="check" size={16} color={customRankMin && customRankMax ? "#4A9EFF" : Colors.dark.textTertiary} />
                      </Pressable>
                    </View>
                  </View>
                  ...
                  <View style={styles.customInputSection}>
                    ...
                    <View style={styles.customInputRow}>
                      ...
                      >
                        <Feather name="check" size={16} color={customCapMin && customCapMax ? "#4A9EFF" : Colors.dark.textTertiary} />
                      </Pressable>
                    </View>
                  </View>
                </>
                ...
                <>
                  ...
                  <View style={styles.optionsList}>
                    {currentDetail.options.filter(o => !o.id.startsWith("rvol")).map(option => (
                      <FilterOptionRow
                        key={option.id}
                        option={option}
                  ...
                  <View style={styles.customInputSection}>
                    ...
                    <View style={styles.customInputRow}>
                      ...
                      <TextInput
                        ...
                        keyboardType="decimal-pad"
                        value={customVolMax}
                        onChangeText={setCustomVolMax}
                      />
                      <Text style={styles.customInputUnit}>조</Text>
                      <Pressable
                        onPress={() => {
                          if (customVolMin && customVolMax) {
                            Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                            setLocalFilters(prev => ({ ...prev, volume: `customVol:${customVolMin}-${customVolMax}` }));
                          }
                        }}
                        style={({ pressed }) => [styles.customApplyBtn, (!customVolMin || !customVolMax) && styles.customApplyBtnDisabled, pressed && { opacity: 0.7 }]}
                      >
                        <Feather name="check" size={16} color={customVolMin && customVolMax ? "#4A9EFF" : Colors.dark.textTertiary} />
                      </Pressable>
                    </View>
                  </View>
                  ...
                  <Text style={[styles.detailSubtitle, { marginBottom: 12 }]}>평소 대비 거래량이 얼마나 터졌는지</Text>
                  <View style={styles.optionsList}>
                    {currentDetail.options.filter(o => o.id.startsWith("rvol")).map(option => (
                      <FilterOptionRow
                        key={option.id}
                  ...
                  <View style={styles.customInputSection}>
                    <Text style={styles.customInputLabel}>직접 설정</Text>
                    <View style={styles.customInputRow}>
                      <Text style={styles.customInputUnit}>평소 대비</Text>
                      <TextInput
                        style={[styles.customInput, localFilters.volume?.startsWith("customRvol:") && styles.customInputActive]}
                        placeholder="배수"
                        placeholderTextColor={Colors.dark.textTertiary}
                        keyboardType="decimal-pad"
                        value={customRvolPct}
                        onChangeText={setCustomRvolPct}
                      />
                      ...
                      <Pressable
                        onPress={() => {
                          if (customRvolPct) {
                            Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                            setLocalFilters(prev => ({ ...prev, volume: `customRvol:${customRvolPct}` }));
                          }
                        }}
                        style={({ pressed }) => [styles.customApplyBtn, !customRvolPct && styles.customApplyBtnDisabled, pressed && { opacity: 0.7 }]}
                      >
                        <Feather name="check" size={16} color={customRvolPct ? "#4A9EFF" : Colors.dark.textTertiary} />
                      </Pressable>
                    </View>
                  </View>
                </>
                  ...
                  <View style={styles.optionsList}>
                    {currentDetail.options.map(option => (
                      <FilterOptionRow
                        key={option.id}
                        option={option}
                        isSelected={localFilters.streak === option.id}
                        onPress={() => toggleOption("streak", option.id)}
                      />
                    ))}
                  </View>
                </>
                ...
                <>
                    ...
                    {([
                      ...
                      return (
                        ...
                        >
                          ...
                          {active && <Feather name="check-circle" size={14} color="#4A9EFF" style={{ position: "absolute", top: 8, right: 8 }} />}
                        </Pressable>
                      );
                    })}
                  </View>
                  ...
                  {localFilters.rsi && (
                    <View style={styles.crSummary}>
                      <Feather name="check-circle" size={13} color="#4A9EFF" />
                      <Text style={styles.crSummaryText}>
                ...
                <>
                  <View style={styles.taGaugeContainer}>
                    <View style={styles.taGaugeBar}>
                      ...
                      <View style={[styles.taGaugeSegment, { flex: 1, backgroundColor: "rgba(74,158,255,0.2)" }]} />
                    ...
                    <View style={styles.taGaugeLabels}>
                      ...
                      <Text style={[styles.taGaugeLabel, { color: "#4A9EFF" }]}>0</Text>
                    ...
                    <View style={styles.taGaugeLabelRow}>
                      ...
                      <Text style={[styles.taGaugeZone, { color: "#4A9EFF" }]}>저변동</Text>
                  ...
                  <View style={styles.taInfoCard}>
                    ...
                    <View style={styles.betaExampleGrid}>
                      ...
                      <View style={styles.betaExampleItem}>
                        <Text style={[styles.betaExampleValue, { color: "#4A9EFF" }]}>β 1.0</Text>
                  ...
                  <View style={styles.betaDirRow}>
                    ...
                    >
                      <Feather name="trending-up" size={16} color={betaDir === "same" ? "#4A9EFF" : Colors.dark.textTertiary} />
                  ...
                  <View style={styles.taChipGrid}>
                    {currentDetail.options
                      ...
                      const color = betaDir === "same"
                        ? (option.id === "same_mid" ? "#4A9EFF" : "#F44336")
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.activeChipsScroll}>
                  {FILTER_CATEGORIES.map(cat => {
                    ...
                    if (!label && val.startsWith("customRvol:")) {
                      label = `RVOL ${val.replace("customRvol:", "")}배 이상`;
                    }
                ...
                return (
                  ...
                  >
                    <View style={styles.tabLabelRow}>
                      <Feather name={group.icon as any} size={13} color={isActive ? "#4A9EFF" : Colors.dark.textTertiary} />
                  ...
                  <View style={styles.tabCards}>
                    {group.categories.map(catId => {
                      ...
                      if (!selectedLabel && hasFilter) {
                        ...
                        else if (val.startsWith("customRvol:")) { selectedLabel = `RVOL ${val.replace("customRvol:", "")}배+`; }
                      ...
                      return (
                        ...
                        >
                          <View style={styles.filterCardTop}>
                            ...
                            <Feather name="chevron-right" size={16} color={hasFilter ? "#4A9EFF" : Colors.dark.textTertiary} />
                          </View>
                          ...
                          {hasFilter && (
                            ...
                            >
                              <Feather name="x" size={12} color="#4A9EFF" />
