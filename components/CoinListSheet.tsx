...
const EMPTY_FILTERS: Record<FilterCategoryId, string | null> = {
  marketCap: null, changeRate: null, volume: null, category: null, staking: null, lending: null,
  circulatingRatio: null, athDrop: null, atlRise: null, streak: null, rsi: null, beta: null,
};
                ...
                {activeFilterEntries.map(([catId, val]) => {
                  ...
                  if (!valueLabel && val) {
                    ...
                    if (val.startsWith("customRank:")) {
                      ...
                      valueLabel = `평소 대비 ${val.replace("customRvol:", "")}%`;
                    } else {
                      valueLabel = val;
                    }
                  }
