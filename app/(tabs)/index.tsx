...
export default function HomeScreen() {
  ...
  const webTopInset = Platform.OS === "web" ? 8 : 0;
    ...
    <View style={styles.screen}>
      ...
      <View style={{ paddingTop: Platform.OS === "web" ? webTopInset : insets.top }}>
        <View style={styles.topNav}>
          <Text style={styles.topNavInactive}>거래소</Text>
          <Text style={styles.topNavInactive}>추천</Text>
          <Text style={styles.topNavActive}>탐색</Text>
          <Text style={styles.topNavInactive}>동향</Text>
        </View>
      </View>
